...
/**
 * Gap/CFS Feature Page: Member lifetime value modeling
 * Slug: member-lifetime-value-modeling
 * Backend: /api/cf-member-lifetime-value-modeling
 */
export default function MemberLifetimeValueModelingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-member-lifetime-value-modeling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Member lifetime value modeling</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict high-value members; proactive engagement/upsell.</p>
