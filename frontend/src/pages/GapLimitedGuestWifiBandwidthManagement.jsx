...
/**
 * Gap/CFS Feature Page: Limited guest-WiFi bandwidth management.
 * Slug: limited-guest-wifi-bandwidth-management
 * Backend: /api/gap-limited-guest-wifi-bandwidth-management
 */
export default function LimitedGuestWifiBandwidthManagementPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-guest-wifi-bandwidth-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited guest-WiFi bandwidth management.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited guest-WiFi bandwidth management.</p>
