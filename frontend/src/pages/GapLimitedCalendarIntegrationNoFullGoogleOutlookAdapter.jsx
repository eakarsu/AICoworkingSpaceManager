...
/**
 * Gap/CFS Feature Page: Limited calendar integration — no full Google/Outlook adapter.
 * Slug: limited-calendar-integration-no-full-google-outlook-adapter
 * Backend: /api/gap-limited-calendar-integration-no-full-google-outlook-adapter
 */
export default function LimitedCalendarIntegrationNoFullGoogleOutlookAdapterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-calendar-integration-no-full-google-outlook-adapter', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited calendar integration — no full Google/Outlook adapter.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited calendar integration — no full Google/Outlook adapter.</p>
