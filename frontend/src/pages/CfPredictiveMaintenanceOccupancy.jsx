...
/**
 * Gap/CFS Feature Page: Predictive maintenance & occupancy
 * Slug: predictive-maintenance-occupancy
 * Backend: /api/cf-predictive-maintenance-occupancy
 */
export default function PredictiveMaintenanceOccupancyPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-maintenance-occupancy', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive maintenance & occupancy</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Combine occupancy patterns with equipment telemetry; predict maintenance needs before failure.</p>
