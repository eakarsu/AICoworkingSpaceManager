...
/**
 * Gap/CFS Feature Page: Amenity utilization prediction
 * Slug: amenity-utilization-prediction
 * Backend: /api/cf-amenity-utilization-prediction
 */
export default function AmenityUtilizationPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-amenity-utilization-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Amenity utilization prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Forecast high-demand amenities; suggest new amenities based on member interests.</p>
