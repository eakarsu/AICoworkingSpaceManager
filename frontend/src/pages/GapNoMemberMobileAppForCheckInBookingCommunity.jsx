...
/**
 * Gap/CFS Feature Page: No member mobile app for check-in/booking/community.
 * Slug: no-member-mobile-app-for-check-in-booking-community
 * Backend: /api/gap-no-member-mobile-app-for-check-in-booking-community
 */
export default function NoMemberMobileAppForCheckInBookingCommunityPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-member-mobile-app-for-check-in-booking-community', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No member mobile app for check-in/booking/community.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No member mobile app for check-in/booking/community.</p>
